...
fun signInScreen() {
    ...
    Box(
        ...
        Text(
            ...
            modifier = Modifier
                .wrapContentSize()
                .padding(start = 152.dp, top = 196.dp)
        )
        ...
        Column(
            modifier = Modifier
                .padding(start = 22.dp, top = 300.dp) // Общий отступ слева
        ) {
            // Текст "Email" (привязан к верхней части прямоугольника)
            Text(
                text = "Email",
                fontFamily = SoraFontFamily,
                fontWeight = FontWeight.W400,
                ...
                color = MaterialTheme.colorScheme.primary,
                modifier = Modifier
                    .padding(bottom = 3.dp) // Небольшой отступ между текстом и прямоугольником
            )
        ...
        Column(
            modifier = Modifier
                .padding(start = 22.dp, top = 369.dp)
        ) {
            Text(
                text = "Password",
                fontFamily = SoraFontFamily,
        ...
        Text(
            ...
            modifier = Modifier
                ...
                .offset(x = 217.dp, y = 441.dp) // Позиция текста (Left: 227px, Top: 441px)
        )
        HorizontalDivider(
            modifier = Modifier
        ...
        Text(
            text = buildAnnotatedString {
                withStyle(
                    style = SpanStyle(
                        color = MaterialTheme.colorScheme.primary // Цвет для "Don't have an account?"
                    )
                ) {
